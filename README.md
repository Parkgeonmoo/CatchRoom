...
- 개인 사유로 숙박 예약을 취소할 경우 발생하는 수수료 문제를 해결하기 위해, 숙박 예약권의 양도 및 중개 거래를 가능하게 하는 플랫폼을 개발하였다.
- 이 플랫폼은 사용자의 불만과 서비스 이탈을 방지하고, 안전하고 신속한 거래를 보장하는 기능을 중점적으로 제공한다.
- 이를 통해 예약 취소로 인한 수수료 부담을 최소화하였으며, 사용자의 만족도를 높이는 서비스를 제공하고 있다.
